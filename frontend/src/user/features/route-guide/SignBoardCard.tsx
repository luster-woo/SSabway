  ...
  if (sign.photoUrl) {
    return (
      <img
        ...
        className="bg-sign h-[clamp(132px,40vw,150px)] w-full rounded-xl object-cover"
      />
    )
  }

  return (
    <div className="bg-sign flex h-[clamp(132px,40vw,150px)] items-stretch overflow-hidden rounded-xl">
      {sign.exitNumber ? (
